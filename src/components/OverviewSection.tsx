    ...
    */
    return (
        <section id="overview" className="relative min-h-[90vh] sm:min-h-[90vh] supports-[height:100svh]:min-h-[90svh] text-white overflow-hidden">
            <Image src="/images/overview.png" alt="Aerial view of Miraf development showing modern buildings, green spaces, and urban landscape" fill priority sizes="100vw" className="object-cover object-center -z-10"/>
            ...
            <div className="container-x relative mx-auto px-4 sm:px-6 lg:px-8 min-h-0 sm:min-h-[90vh] supports-[height:100svh]:sm:min-h-[90svh] flex flex-col justify-between py-8 sm:py-12 lg:py-20 pb-8 lg:pb-10">
                <div className="grid lg:hidden grid-cols-2 gap-4 sm:gap-6 pt-6 sm:pt-8 text-center">
                    ...
                    <AnimatedText delay={0.2} direction="up" duration={0.8}>
                        <div className="flex flex-col items-center gap-2 sm:gap-3 text-burgundy">
                            <Image src="/images/business.png" alt="Business tower icon" width={40} height={40} className="w-10 h-10 sm:w-12 sm:h-12 image-hover" loading="lazy" />
                    ...
                    <AnimatedText delay={0.3} direction="up" duration={0.8}>
                        <div className="flex flex-col items-center gap-2 sm:gap-3 text-burgundy">
                            <Image src="/images/hotel.png" alt="Hotel building icon" width={40} height={40} className="w-10 h-10 sm:w-12 sm:h-12 image-hover" loading="lazy" />
                    ...
                    <AnimatedText delay={0.4} direction="up" duration={0.8}>
                        <div className="flex flex-col items-center gap-2 sm:gap-3 text-burgundy">
                            <Image src="/images/plaza.png" alt="Shopping plaza icon" width={40} height={40} className="w-10 h-10 sm:w-12 sm:h-12 image-hover" loading="lazy" />
